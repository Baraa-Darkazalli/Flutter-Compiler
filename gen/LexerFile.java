...
public class LexerFile extends Lexer {
	...
	public static final int
		...
		ID=208, INTEGER=209, WS=210, NEWLINE=211, SEA_WS=212;
	...
	private static String[] makeRuleNames() {
		return new String[] {
			"INT", "DOUBLE", "LETTER", "DIGIT", "EXPONENT", "HEX_DIGIT", "ESC", "UNICODE", 
			"SCAFFOLD", "STRING_SINGLE_QU", "STRING_SINGLE_DOUBLE_QU", "KEYWORD", 
			"COMMA", "SEMICOLON", "COLON", "DOT", "PLUS", "MINUS", "MULTIPLY", "DIVISION", 
