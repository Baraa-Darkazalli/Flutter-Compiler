...
public interface ParserFileListener extends ParseTreeListener {
	 ...
	 * @param ctx the parse tree
	 */
	void enterBodyAttr(ParserFile.BodyAttrContext ctx);
	/**
	 * Exit a parse tree produced by {@link ParserFile#bodyAttr}.
	 * @param ctx the parse tree
	 */
	void exitBodyAttr(ParserFile.BodyAttrContext ctx);
	/**
	 * Enter a parse tree produced by {@link ParserFile#drawerAttr}.
	 * @param ctx the parse tree
	 */
	void enterDrawerAttr(ParserFile.DrawerAttrContext ctx);
	/**
	 * Exit a parse tree produced by {@link ParserFile#drawerAttr}.
	 * @param ctx the parse tree
	 */
	void exitDrawerAttr(ParserFile.DrawerAttrContext ctx);
	/**
	 * Enter a parse tree produced by {@link ParserFile#appBarAttr}.
	 * @param ctx the parse tree
	 */
	void enterAppBarAttr(ParserFile.AppBarAttrContext ctx);
	/**
	 * Exit a parse tree produced by {@link ParserFile#appBarAttr}.
	 * @param ctx the parse tree
	 */
	void exitAppBarAttr(ParserFile.AppBarAttrContext ctx);
	/**
	 * Enter a parse tree produced by {@link ParserFile#bottomNavigationBarAttr}.
	 * @param ctx the parse tree
	 */
	void enterBottomNavigationBarAttr(ParserFile.BottomNavigationBarAttrContext ctx);
	/**
	 * Exit a parse tree produced by {@link ParserFile#bottomNavigationBarAttr}.
	 * @param ctx the parse tree
	 */
	void exitBottomNavigationBarAttr(ParserFile.BottomNavigationBarAttrContext ctx);
	/**
	 * Enter a parse tree produced by {@link ParserFile#floatingActionButtonAttr}.
	 * @param ctx the parse tree
	 */
	void enterFloatingActionButtonAttr(ParserFile.FloatingActionButtonAttrContext ctx);
	/**
	 * Exit a parse tree produced by {@link ParserFile#floatingActionButtonAttr}.
	 * @param ctx the parse tree
	 */
	void exitFloatingActionButtonAttr(ParserFile.FloatingActionButtonAttrContext ctx);
	/**
	 * Enter a parse tree produced by {@link ParserFile#backGroundColorAttr}.
	 * @param ctx the parse tree
	 */
	void enterBackGroundColorAttr(ParserFile.BackGroundColorAttrContext ctx);
	/**
	 * Exit a parse tree produced by {@link ParserFile#backGroundColorAttr}.
	 * @param ctx the parse tree
	 */
	void exitBackGroundColorAttr(ParserFile.BackGroundColorAttrContext ctx);
}