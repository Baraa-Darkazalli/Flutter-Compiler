...
public interface ParserFileListener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by {@link ParserFile#childAttr}.
	 * @param ctx the parse tree
	 */
	void enterChildAttr(ParserFile.ChildAttrContext ctx);
	/**
	 * Exit a parse tree produced by {@link ParserFile#childAttr}.
	 * @param ctx the parse tree
	 */
	void exitChildAttr(ParserFile.ChildAttrContext ctx);
	/**
	 * Enter a parse tree produced by {@link ParserFile#widthAttr}.
	 * @param ctx the parse tree
	 */
	void enterWidthAttr(ParserFile.WidthAttrContext ctx);
	/**
	 * Exit a parse tree produced by {@link ParserFile#widthAttr}.
	 * @param ctx the parse tree
	 */
	void exitWidthAttr(ParserFile.WidthAttrContext ctx);
	/**
	 * Enter a parse tree produced by {@link ParserFile#heightAttr}.
	 * @param ctx the parse tree
	 */
	void enterHeightAttr(ParserFile.HeightAttrContext ctx);
	/**
	 * Exit a parse tree produced by {@link ParserFile#heightAttr}.
	 * @param ctx the parse tree
	 */
	void exitHeightAttr(ParserFile.HeightAttrContext ctx);
	/**
	 * Enter a parse tree produced by {@link ParserFile#colorAttr}.
	 * @param ctx the parse tree
	 */
	void enterColorAttr(ParserFile.ColorAttrContext ctx);
	/**
	 * Exit a parse tree produced by {@link ParserFile#colorAttr}.
	 * @param ctx the parse tree
	 */
	void exitColorAttr(ParserFile.ColorAttrContext ctx);
	/**
